...
{
	// 保证类名跟文件名一致，这样也方便查找
	public class ParasiticNanitesProjTest2 : ModItem
	{
		// 设置物品名字，描述的地方
		public override void SetStaticDefaults()
		{
			...
			DisplayName.SetDefault("ParasiticNanitesProjTest2");
		...
		public override void SetDefaults()
		{
			...
			//item.shoot = ModContent.ProjectileType<Projt1>();
			item.shoot = 1;
			item.shootSpeed = 1f;
		...
		{
			spriteBatch.Draw(ParasiticNanitesDraw.texture,Main.MouseScreen,Color.White);
