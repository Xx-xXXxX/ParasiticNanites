...
{
	public class ParasiticNanitesSandProjectile : ModProjectile
	{
		...
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Parasitic Nanites Sand Ball");
			DisplayName.SetDefault("寄生机器人沙球");
		...
		public override void SetDefaults() {
			...
			tileType = ModContent.TileType<ParasiticNanitesSand>();
		...
		{
			target.AddBuff(ModContent.BuffType<ParasiticNanitesBuff>(), 10);
		}
